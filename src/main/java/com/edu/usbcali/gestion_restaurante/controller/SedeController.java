...
public class SedeController {
    ...
    public ResponseEntity<SedeDTO> actualizarSede(@PathVariable Integer id,
        @RequestBody @Valid UpdateSedeRequest updateSedeRequest) throws Exception {
        SedeDTO sederesponSedeDTO = sedeService.actualizarSede(id, updateSedeRequest);
        return ResponseEntity.ok(sederesponSedeDTO);
    }
